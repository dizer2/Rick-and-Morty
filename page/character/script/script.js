...
function getCharacters(n){
	...
	$(".characterCard").click(function (e) { 
		...
		$(".popup__card").addClass("popup__card__active");
		$("body").addClass("body__active");
			...
			$(".popup__card").append(`<div  id="${data.id}" class="characterCard">
			<div class="avatar__box">
			<div class="avatar__bg">
				<div style="background-image: url(${data.image});" class="avatar"></div>
			</div>
			</div>
			<div class="charapter__nameBox">
				<p class="charapter__name">${data.name}</p>
	
			</div>
			<div class="description__container">
				<p class="description__teg">Location: <span class="desciption__span location">${data.location.name}</span></p>
				<p class="description__teg">Species: <span class="desciption__span species">${data.species}</span></p>
				<p class="description__teg">Status: <span class="desciption__span status">${data.status}</span></p>
				<p class="description__teg">Gender: <span class="desciption__span gender">${data.gender}</span></p>
			</div>
		...
		$(".popup").click(function () { 
			...
			$(".popup__card").removeClass("popup__card__active");
